...
Beta.20 was a one-version notarization exception. Beta.21 restored accepted Apple notarization, app and DMG stapling, and Gatekeeper acceptance for Developer-ID-signed macOS packages. Beta.23 keeps those macOS gates and intentionally ships unsigned Windows x64 setup and portable packages only on the Internal Beta channel; production candidates remain Authenticode fail-closed.
